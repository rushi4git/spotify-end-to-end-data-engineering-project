...
def album(data):
    ...
    for row in data['items']:
        ...
        album_elemment = {'album_id': album_id, 'name':album_name, 'release_date':album_release_date,'total_tracks':album_total_track,'url':album_url}
        album_list.append(album_elemment)
    return album_list
...
def lambda_handler(event, context):
    s3 = boto3.client('s3')
    Bucket = "spotify-etl-project-rushi"
